...
SimpleVRClass *gSimpleVRObject =NULL;
...
Java_com_anandmuralidhar_simplevrandroid_SimpleVRActivity_CreateObjectNative(JNIEnv *env,
                                                                             jobject instance,
                                                                             jobject assetManager,
                                                                             jstring pathToInternalDir) {

    gHelperObject = new MyJNIHelper(env, instance, assetManager, pathToInternalDir);
    gSimpleVRObject = new SimpleVRClass();
}

JNIEXPORT void JNICALL
Java_com_anandmuralidhar_simplevrandroid_SimpleVRActivity_DeleteObjectNative(JNIEnv *env,
                                                                             jobject instance) {
    if (gSimpleVRObject != NULL) {
        delete gSimpleVRObject;
    }
    gSimpleVRObject = NULL;
